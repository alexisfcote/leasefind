...
class LeaseBuster(AutoListing):
    ...
    def get_listing(self):
        headers = {
            ...
            'referer': 'https://leasebusters.com/fr/Search-for-a-lease-take-over-vehicle.asp',
        ...
        response = requests.post('https://leasebusters.com/fr/lease-take-over-vehicle-gallery-results.asp', headers=headers, data=data)
